...
<section class="relative z-10 max-w-3xl mx-auto px-6 py-16">
    <div class="text-center">
        <div class="glass-effect rounded-3xl p-12 mb-8 animate-fade-in">
            <img src="{{ asset('assets/front/images/404.png') }}" class="mx-auto mb-6 rounded-2xl shadow-lg max-h-72 object-cover" alt="404 Not Found" />
            <h1 class="text-4xl md:text-6xl font-bold mb-4 leading-tight text-blue-600">404</h1>
            <h2 class="text-2xl md:text-3xl font-semibold text-white mb-8">Page Not Found</h2>
