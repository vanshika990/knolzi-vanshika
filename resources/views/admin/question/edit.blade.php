<x-layout-admin-base>
    ...
    <form class="kt-form" action="{{ route('admin.question.update',$questionDetail->id) }}" name="updatequestion" id="updatequestion" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                            ...
                            <div class="py-3 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-solid " name="course_id" id="course_id">
                                        ...
                                        <option value="{{ $course->course_id }}" {{ $course->course_id == $questionDetail->course_id ? 'selected' : ''}} >{{ $course->course_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
            ...
            $(document).ready(function () {
                ...
                $("#updatequestion").validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        var _url = '{{ route("admin.question.update",$questionDetail->id) }}';
                        $.ajaxSetup({
                            headers: {
