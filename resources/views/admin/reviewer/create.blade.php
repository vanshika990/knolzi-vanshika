<div class="modal fade" id="kt_modal_view_reviewer" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="card mb-5 mb-xl-8">
                    <div class="card-body p-3">
                        <form class="kt-form" action="{{ route('admin.reviewer.store') }}" name="createreviewer" id="createreviewer" method="POST">
                            @csrf
                            <div class="row">
                                <div class="py-3 col-xxl-6">
                                    <label for="name" class="required form-label">Reviewer Name</label>
                                    <input type="text" name="name" class="form-control form-control-solid" placeholder="Reviewer Name" id="name"  required="required">
                                </div>
                                <div class="py-3 col-xxl-6">
                            ...
                            <div class="py-3">
                                ...
                                <input type="number" class="form-control form-control-solid" name="mobile_no" id="mobile_no" placeholder="Mobile No">
                            </div>
                            <div class="row">
                                <div class="py-3 col-xxl-6">
                            ...
                            <div class="py-3 col-xxl-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-select form-select-solid" name="select_course[]" id="select_course" multiple></select>
                                </div>
                            </div>
                            <div class="py-3">
                                <div class="text-end">
    ...
    <script type="text/javascript">
        $('#kt_modal_view_reviewer').modal('show');
        $(document).ready(function () {
            $("#createreviewer").validate({
                rules: {
                    name: "required",
                    email: "required",
                    mobile_no: "required",
                    ...
                    $(".loading").show();
                    var _url = '{{ route("admin.reviewer.store") }}';
                    var data = $("#createreviewer").serialize();
