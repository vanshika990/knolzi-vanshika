            ...
            <div class="modal-body">
                <div class="card mb-5 mb-xl-8">
                    <div class="card-body p-3">
                        <form class="kt-form" action="{{route('admin.category.update',$category->id)}}" id="updatecategory" name="updatecategory" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="py-3 col-md-6">
                                    <label for="Name" class="required form-label">Name</label>
                                    <input type="text" name="name" class="form-control form-control-solid" placeholder="Enter Name" value="{{ $category->name }}"  required="required" />
                                </div>
                                <div class="py-3 col-md-6">
                                ...
                                <div class="py-3 col-md-12">
                                    ...
                                    <textarea name="category_sub_description" id="category_sub_description" class="form-control form-control-solid" rows="3" cols="119" placeholder="Enter category sub description..." required>{{ $category->category_sub_description }}</textarea>
                                </div>
                                <div class="py-3 col-md-12">
                                    <label for="category_description" class="required form-label">Category Description</label>
                                    <textarea name="category_description" id="category_description" class="form-control form-control-solid" rows="10" cols="80" required>{{ $category->category_description }}</textarea>
                                </div>
                                <div class="py-3 col-md-6">
                                    <label for="meta title" class=" required form-label">SEO meta title</label>
                                    <input type="text" name="meta_title" id="meta_title" class="form-control form-control-solid" placeholder="Enter SEO meta title" value="{{ $category->meta_title }}" required />
                                </div>
                                <div class="py-3 col-md-6">
                                    <label for="meta keyword" class=" required form-label">SEO meta keyword</label>
                                    <input type="text" name="meta_keyword" id="meta_keyword" class="form-control form-control-solid" placeholder="Enter SEO meta keyword" value="{{ $category->meta_keyword }}" required />
                                </div>
                                <div class="py-3 col-md-12">
                                    <label for="meta description" class=" required form-label">SEO meta description</label>
                                    <textarea name="meta_description" id="meta_description" class="form-control form-control-solid" rows="3" cols="119" placeholder="Enter SEO meta description..." required >{{ $category->meta_description }}</textarea>
                                </div>
                                <div class="py-3">
                                    <div class="text-end">
...
<script type="text/javascript">
    ...
    $('#kt_modal_edit_category').on('hidden.bs.modal', function() {
        $(".modal").remove();
    });
