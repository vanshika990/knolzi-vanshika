<div class="modal fade" id="kt_modal_request_demo_details" tabindex="-1" aria-hidden="true">
...
<script type="text/javascript">
    $('#kt_modal_request_demo_details').modal('show');
    $('#kt_modal_request_demo_details').on('hidden.bs.modal', function() {
        $(".modal").remove();
