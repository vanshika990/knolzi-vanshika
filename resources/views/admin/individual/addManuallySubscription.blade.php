<div class="modal fade" id="kt_modal_view_subscription" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="card-body p-3">
                        <form class="kt-form" name="addsubscription" id="addsubscription" method="POST" >
                            ...
                            <div class="row">
                                ...
                                <div class="py-3 col-md-12 choosn-sle">
                                    <label for="select course" class="required form-label">Select Course</label>
                                    <select name="course_id" id="course_id" class="form-select form-select-solid select-box" onchange="priceGet(this.options[this.selectedIndex].getAttribute('dataattr'));sub_day_get(this.options[this.selectedIndex].getAttribute('sub_day'));">
                                ...
                                <div class="py-3 col-md-6">
                                    ...
                                    <input type="number" name="price" id="price" class="form-control form-control-solid" placeholder="Course price" min="1" required="required" readonly/>
                                </div>
                                <div class="py-3 col-md-6">
    ...
    <script type="text/javascript">
        ...
        $("#addsubscription").submit(function() {
            ...
            $.ajax({
                url: "{{ route('indvaddmanualsubscriptionpost') }}",
                type: 'POST',
                contentType: false,
                data: data,
                processData: false,
