<x-layout-admin-base>
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-lg-0 mb-sm-0 mb-0 lh-1">
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3"><a href="{{ route('admindashboard') }}">Dashboard</a>
                    ...
                    <small class="text-muted fs-7 fw-bold my-1 ms-1">Notification</small>
                </h1>
            </div>
        </div>
    </div>
            ...
            <div class="card mb-5 mb-xl-8">
                <div class="card-header border-2 pt-2">
                    ...
                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="" data-bs-original-title="Click to add a Question Intent">
                        <a href="javascript:void(0)" onclick="CreateNotification()" class="btn btn-sm btn-primary">
    ...
    <script type="text/javascript">
        function CreateNotification() {
            GetCallAjax("{{ route('admin.notification.create') }}");
        }

        function Viewdetails(n_id) {
            var id = $(n_id).data('id');
            $(".loading").show();
            var _url = '{{ route("getnotificationhistory", ":id") }}';
