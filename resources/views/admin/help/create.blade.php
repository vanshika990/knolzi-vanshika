<div class="modal fade" id="kt_modal_create_help" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="card mb-5 mb-xl-8">
                    <div class="card-body p-3">
                        <form class="kt-form" action="{{ route('admin.help.store') }}" name="createhelp" id="createhelp" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
...
<script type="text/javascript">
    $('#kt_modal_create_help').modal('show');
    $(document).ready(function() {
        $("#createhelp").validate({
            rules: {
                ...
                var _url = '{{ route("admin.help.store") }}';
                $.ajaxSetup({
                    headers: {
