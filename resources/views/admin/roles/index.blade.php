<x-layout-admin-base>
        ...
        <div id="kt_content_container" class="container">
            <div class="card mb-5 mb-xl-8">
                <div class="card-header border-2 pt-2">
                    ...
                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="" data-bs-original-title="Click to add a Role">
                        <a href="javascript:void(0)" onclick="CreateRole()" class="btn btn-sm btn-primary">
    ...
    <script type="text/javascript">
        function CreateRole() {
            GetCallAjax("{{ route('admin.roles.create') }}");
        }
        function editRole(id) {
            $(".loading").show();
            var _url = '{{ route("admin.roles.edit", ":id") }}';
        ...
        function deleteRole(id) {
            swal({
                ...
                if (isConfirm) {
                    var _url = '{{ route("admin.roles.destroy", ":id") }}';
                    _url = _url.replace(':id', id);
                    DeleteAjaxCall(_url);
                } else {
