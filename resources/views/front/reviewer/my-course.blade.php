                ...
                <div class="col-lg-3 mb-3 col-md-4">
                    <div class="course-block">
                        ...
                        <div class="course-price">
                            ...
                            @else
                            @if($row['state'] == "todo")
                            <a class="btn btn-primary float-end" href="{{ route('reviewercourselearn', encrypt($row->course_id)) }}">Start</a>
                            @else
                            <a class="btn btn-primary float-end" href="{{ route('reviewercourselearn', encrypt($row->course_id)) }}">Resume</a>
                            @endif
                            @endhasanyrole
                        </div>
                    </div>
