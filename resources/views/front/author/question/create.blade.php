<x-layout-font-dashboard-base>
    ...
    <form class="kt-form" action="{{ route('user.my-course-question.store') }}" name="createquestion" id="createquestion_author" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="post d-flex flex-column-fluid" id="kt_post_author">
                            ...
                            <div class="py-3 col-md-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-select form-select-solid select-box" name="course_id" id="course_id">
                                        ...
                                        <option value="{{ $course['course']['course_id'] }}">{{ $course['course']['course_name'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post1_author">
            <div id="kt_content_container" class="container">
                <div class="card mb-5 mb-xl-8">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post2_author">
            <div id="kt_content_container" class="container">
                <div class="card mb-5 mb-xl-8">
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post3_author">
            <div id="kt_content_container" class="container">
                    <div class="card mb-5 mb-xl-8">
                        <div class="text-end">
...
<script>
        ...
        $(document).ready(function() {
            ...
            $('input[name=question_media_type]').click(function() {
                ...
                if (type == 'single') {
                    ...
                    $('#kt_post1_author').show();
                    $('#kt_post2_author').show();
                    //$('#question_type').show();
                    $('#question_media_single').show();
                ...
                if (type == 'scorm') {
                    ...
                    $('#kt_post1_author').removeClass('d-flex');
                    $('#kt_post2_author').removeClass('d-flex');
                    $('#kt_post1_author').hide();
                    $('#kt_post2_author').hide();
                    //$('#question_type').hide();
                    $('#question_media_single').hide();
        ...
        // help_image add remove end
        $(document).ready(function() {
            $("#createquestion_author").validate({
                rules: {
                    question_name: {
                        required: true,
                    },
                ...
                submitHandler: function(form) {
                    ...
                    var _url = '{{ route("user.my-course-question.store") }}';
                    $.ajaxSetup({
                        headers: {
