<div class="modal fade" id="kt_modal_view_author_detail" tabindex="-1" aria-hidden="true">
...
<script type="text/javascript">
    $('#kt_modal_view_author_detail').modal('show');
    $('#kt_modal_view_author_detail').on('hidden.bs.modal', function() {
        $(".modal").remove();
