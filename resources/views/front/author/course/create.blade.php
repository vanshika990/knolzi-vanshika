            ...
            <div id="kt_content_container" class="container">
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body py-3">
                        <form class="kt-form" action="{{ route('user.view-my-course.store') }}" name="createcourse" id="createcourse" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                @if($user_role == 'institute')
                                    <div class="py-3 choosn-sle col-md-6">
                                        ...
                                        <select multiple class="form-select form-select-solid select-box" name="user_id[]" id="user_id" required>
                                            <option value="{{ Auth::user()->id }}" selected locked="locked">{{ Auth::user()->name }}</option>
                                        </select>
                                    </div>
                                @endif
