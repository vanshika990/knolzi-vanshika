<div class="modal fade" id="kt_modal_view_orguser_detail" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="symbol symbol-200px w-100">
                                ...
                                <div class="mt-4 mb-2">
                                    <div class="fw-bold fs-6 mb-4 text-center">
                                        <div class="mb-2">
                                            <a href="javascript:void(0)" class="text-primary fs-2 fw-bolder me-1">{{ $user->name }}</a>
...
<script type="text/javascript">
    $('#kt_modal_view_orguser_detail').modal('show');
    $('#kt_modal_view_orguser_detail').on('hidden.bs.modal', function() {
        $(".modal").remove();
