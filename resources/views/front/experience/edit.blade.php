<div class="modal fade" id="kt_modal_edit_experience" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card">
                    <form class="kt-form" action="{{route('update-work-experience')}}" id="updateeexperience" name="updateeexperience" method="POST">
                    @csrf
                        <div class="card-body p-3">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="company_name" name="company_name" value="{{ $experience->company_name }}" placeholder="Your Company Name" required>
                                </div>
                                <div class="col-lg-6 col-md-6 mb-3">
                                    <div class="form-group">
                                        <label for="experience" class="form-label">Experience</label>
                                        <input type="text" class="form-control" id="experience" name="experience" value="{{ $experience->experience }}" placeholder="Your experience" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 mb-3">
                                    <div class="form-group">
                                        <label for="year" class="form-label">Year</label>
                                        <input type="number" class="form-control" id="year" name="year" maxlength="4" value="{{ $experience->year }}" placeholder="Year" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 mb-3">
                                    <div class="form-group">
                                        <label for="role" class="form-label">Role</label>
                                        <input type="text" class="form-control" id="role" name="role" value="{{ $experience->role }}" placeholder="Your role" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 mb-3">
                                    <div class="form-group">
                                        <label for="designation" class="form-label">Designation</label>
                                        <input type="text" class="form-control" id="designation" name="designation" value="{{ $experience->designation }}" placeholder="Your designation" required>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $('#kt_modal_edit_experience').modal('show');
        $('#kt_modal_edit_experience').on('hidden.bs.modal', function() {
            $(".modal").remove();
        });

        $(document).ready(function() {
            $("#updateeexperience").validate({
                rules: {
                    'company_name': {
                        required: true,
                    }
