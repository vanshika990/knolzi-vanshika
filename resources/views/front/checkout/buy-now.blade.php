            ...
            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-sm-4 col-5">
                                            <div class="course-image">
                                                <a href="">
                                                    <img src="{{ $checkout_data->course_image }}" alt="{{ $checkout_data->course_name }}" class="img-fluid">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-lg-5 col-sm-7 col-7">
                                            <div class="course-title">
                                                <a href="{{ route('coursedetails', $checkout_data->slug) }}">{{ $checkout_data->course_name }}</a>
                                            </div>
                                            <div class="course-price">
                                                @if($is_discount == '1')
                                                <span><del>{{ getCurrencySymbol() }}{{ $original_price }}</del></span><br/><span>{{ getCurrencySymbol() }}{{ $payable_amount }}</span>
                                                @else
                                                <span>{{ getCurrencySymbol() }}{{ $original_price }}</span>
                                                @endif
                                            </div>
                                        </div>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-5 order-lg-1 order-md-1 order-12 mb-md-4">
                    <div class="checkout-summary">
                        <h3>Summary</h3>
                        <ul>
                            <li><p>Original Price</p><span>{{ getCurrencySymbol() }}{{ $original_price }}/-</span></li>
                            <li><p>Coupon Discounts</p><span>{{ getCurrencySymbol() }}{{ $discount }}/-</span></li>
                        </ul>
                        <div class="border"></div>
                        <ul class="chk-summ-total">
                            <li><p>Total:</p><span>{{ getCurrencySymbol() }}{{ $payable_amount }}/-</span></li>
                        </ul>
                        ...
                        <div class="card-body text-center" id="paytm_btn">
                            <form method="post" action="{{route('paytm.payment')}}">
                                ...
                                <input type="hidden" name="amount" placeholder="Amount" value="{{ $payable_amount }}" class="form-control"/>
