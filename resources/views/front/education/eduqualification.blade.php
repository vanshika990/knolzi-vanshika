<x-layout-front-base>
                        ...
                        <div class="card-body">
                            ...
                            <div class="left-profile-menu">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="{{route('education-qualification')}}">Education & Qualifications</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{route('work-experience')}}">Work Experiance</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header cursor-pointer">
                            <div class="card-title m-0">
                                <h4 class="fw-bolder m-0">Education Qualifications</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row gx-9 gy-6">
                                <div class="col-xl-6 mb-3">
                                    <div class="d-flex justify-content-around align-items-center p-3 border-primary content card-dashed bg-light-primary text-center">
                                        <div class="">
                                            <div class="fs-6 text-gray-600 mb-3">Do you need to Add Education Details?</div>
                                            <a href="javascript:void(0)" onclick="addeducation()" class="btn btn-sm btn-primary border-radius-5px" >Add Educations</a>
                                        </div>
                                    </div>
                                </div>
                                @if(!empty($data))
                                ...
                                <div class="col-xl-6 mb-3">
                                    <div class="d-lg-flex d-block justify-content-between align-items-center p-3 content card-dashed">
                                        <div class="">
                                            <div class="mb-2">
                                                <div class="fs-6 fw-bolder mb-0">Education background</div>
                                                <div class="fs-6 text-gray-600">{{ $data->degree }}</div>
                                            </div>
                                            <div class="mb-2">
                                                <div class="fs-6 fw-bolder mb-0">University</div>
                                                <div class="fs-6 text-gray-600">{{ $data->university }}</div>
                                            </div>
                                            <div class="mb-2">
                                                <div class="fs-6 fw-bolder mb-0">Institute</div>
                                                <div class="fs-6 text-gray-600">{{ $data->institute }}</div>
                                            </div>
                                            <div class="mb-2">
                                                <div class="fs-6 fw-bolder mb-0">Stream</div>
                                                <div class="fs-6 text-gray-600">{{ $data->stream }}</div>
                                            </div>
                                            <div class="mb-2">
                                            ...
                                            <div class="mb-2">
                                                <div class="fs-6 fw-bolder mb-0">Grade</div>
                                                <div class="fs-6 text-gray-600">{{ $data->grade }}</div>
                                            </div>
                                        </div>
                                        <div class="py-2">
                                            @php $id = encrypt($data->id) @endphp
                                            <a href="javascript:void(0)" data-id = "{{$id}}"  onclick="deleteeduqua(this)" class="btn btn-sm btn-outline-secondary me-3" >Delete</a>
                                            <a href="javascript:void(0)" data-id = "{{$id}}"  onclick="editeduqua(this)" class="btn btn-sm btn-light me-3" >Edit</a>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
    ...
    <script type="text/javascript">
        ...
        function editeduqua(identifier) {
            ...
            $(".loading").show();
            var _url = '{{ route("edit-edu-qua", ":id") }}';
        ...
        function deleteeduqua(identifier) {
            ...
            swal({
                ...
                if (isConfirm) {
                    var _url = '{{ route("edu-qua-delete", ":id") }}';
                    _url = _url.replace(':id', id);
                    $.ajax({
                        url: _url,
                        type: 'GET',
