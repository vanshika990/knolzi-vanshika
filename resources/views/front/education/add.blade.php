<div class="modal fade" id="kt_modal_add_education" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card">
                    <form class="kt-form" action="{{route('add-edu-qua-post')}}" id="addeducation" name="addeducation" method="POST">
                    @csrf
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 mb-3">
                                    <label for="degree" class="form-label">Education Background</label>
                                    <input type="text" class="form-control" id="degree" name="degree" value="{{ old('university') }}" placeholder="Your Education Background" required>
                                </div>
                                <div class="col-lg-6 col-md-6 mb-3">
                                    <div class="form-group">
                                        <label for="university" class="form-label">University</label>
                                        <input type="text" class="form-control" id="university" name="university" value="{{ old('university') }}" placeholder="Your University" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 mb-3">
                                    <div class="form-group">
                                        <label for="institute" class="form-label">Institute</label>
                                        <input type="text" class="form-control" id="institute" name="institute" value="{{ old('institute') }}" placeholder="Institute" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 mb-3">
                                    <div class="form-group">
                                        <label for="stream" class="form-label">Stream</label>
                                        <input type="text" class="form-control" id="stream" name="stream" value="{{ old('stream') }}" placeholder="Your stream" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 mb-3">
                                    <div class="form-group">
                                        <label for="year" class="form-label">Year</label>
                                        <input type="number" class="form-control" id="year" name="year" maxlength="4" value="{{ old('year') }}" placeholder="Your Education Year" required>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 mb-3">
                                    <div class="form-group">
                                        <label for="grade" class="form-label">Grade</label>
                                        <input type="number" class="form-control" id="grade" name="grade" value="{{ old('grade') }}" placeholder="Your Grade" required>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        $('#kt_modal_add_education').modal('show');
