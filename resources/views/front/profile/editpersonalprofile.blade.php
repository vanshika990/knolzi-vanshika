    ...
    <section class="login-page mt-5 mb-5">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    <form method="POST" action="{{ route('update-personal-profile') }}" name="update-personal-profile" id="update-personal-profile">
                        @csrf
                        <div class="card">
                            <div class="card-header cursor-pointer">
                                ...
                                <button type="submit" class="btn btn-primary align-self-center">Update Profile</button>
                            </div>
                            <div class="card-body">
                                <div class="p-9">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="email" name="email" value="{{$user->email}}" placeholder="Email address" disabled>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 mb-3">
                                            <label for="age" class="form-label">Age</label>
                                            <select id="age" name="age" class="form-select form-select-solid" required="required">
