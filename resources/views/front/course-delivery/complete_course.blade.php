        ...
        <nav class="navbar navbar-expand-xl edupme-nav">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('assets/front/images/logo.svg') }}" alt="knolzi logo" width="100">
                </a>
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
                    ...
                    <ul class="navbar-nav menu-right align-items-center delivery-right-menu">
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="modal" href="#RateThisCourseModal" role="button"><i class="fas fa-star-half-alt"></i> Rate this course</a>
                        </li>
            ...
            if (xhr.status == 422) {
                if (xhr.responseJSON.errors) {
                    $.each(xhr.responseJSON.errors, function(i, val) {
                        errors += "<b><p style='color:#F44336'>" + val[0] + "</p></b><br/>";
                    });
                    if (errors !== "") {
