...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <title>419 Page Expired | {{ config('app.name', 'Knolzi') }}</title>

        <meta name="description" content="419 Page Expired - Knolzi">

        <!-- Google / Search Engine Tags -->
        <meta itemprop="name" content="419 Page Expired - Knolzi">
        <meta itemprop="description" content="419 Page Expired - Knolzi">
        <meta itemprop="image" content="{{ asset('assets/front/images/logo.png') }}">

        <!-- Facebook Meta Tags -->
        <meta property="og:url" content="{{ url()->current() }}">
        <meta property="og:type" content="website">
        <meta property="og:title" content="419 Page Expired - Knolzi">
        <meta property="og:description" content="419 Page Expired - Knolzi">
        <meta property="og:image" content="{{ asset('assets/front/images/logo.png') }}">

        <!-- Twitter Meta Tags -->
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:title" content="419 Page Expired - Knolzi">
        <meta name="twitter:description" content="419 Page Expired - Knolzi">
