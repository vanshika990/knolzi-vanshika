...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <meta itemprop="name" content="@yield('meta_title','default description')">
        <meta itemprop="description" content="@yield('meta_description','Knolzi is The one-stop destination for learning and teaching online. Start learning today and grow. Make your Future brighter with us.')">
        <meta itemprop="keywords" content="@yield('meta_keywords','')">
        <meta itemprop="image" content="@yield('meta_image',asset('assets/front/images/logo.png'))">
    ...
    <body  id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed toolbar-tablet-and-mobile-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
        ...
        <div class="d-flex flex-column flex-root">
            ...
            <div class="page d-flex flex-row flex-column-fluid">
                <x-layout-font-dashboard-sidebar/>
                <!--begin::Wrapper-->
                <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                    <x-layout-font-dashboard-header/>
                    <!--begin::Content-->
        ...
        <!--end::Root-->
        <x-layout-font-dashboard-footer/>
    </body>
</html>
