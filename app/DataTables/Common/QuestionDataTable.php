...
class QuestionDataTable extends DataTable {
    ...
    public function dataTable($query) {
        return datatables()
                        ...
                        ->addColumn('action', function (Collection $model) {
                            ...
                            $edit = route('admin.question.edit', ['question' => encrypt($model->get('id'))]);
                            ...
                            $btn = '<button type="button" class="btn btn-sm btn-info px-4 me-2" data-id = "' . encrypt($model->get('id')) . '" onclick="ViewquestionDetail(this)" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-placement="top" title="View Question Details"><i class="bi bi-eye pe-0 fs-3"></i></button>'
                                    . '<a href="' . $edit . '" class="btn btn-sm btn-success px-4 me-2" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-placement="top" title="Edit question"><i class="bi bi-pencil fs-3"></i></a>'
                                    . '<a href="javascript:void(0)" id="" data-id = "' . encrypt($model->get('id')) . '" class="btn btn-sm btn-danger px-4 me-2" onclick="deletequestion(this)"  data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-placement="top" title="Delete question"><i class="bi bi-trash fs-3"></i></a>'
                                    . '<a href="javascript:void(0)" id="" data-id = "' . encrypt($model->get('id')) . '" class="btn btn-sm btn-secondary px-4 me-2" onclick="clonequestion(this)"  data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-placement="top" title="Clone question"><i class="bi bi-journals fs-3"></i></a>';
                            return $btn;
                        });
    }
    ...
    public function query(CourseQuestion $model, Request $request) {
        ...
        if (isset($request->id) && !empty($request->id)) {
            ...
            $data = $model->select()->with('course')->where('is_delete', '0')->get();
        }
