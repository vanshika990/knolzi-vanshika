    ...
    public function index(Request $request) {
        if (isset($_SERVER['HTTP_REFERER'])) {
            ...
            if ($total_price > 0) {
                ...
                return view('frontend.checkout')->with(['orderId' => $orderId, 'checkout_data' => $data, 'total_price' => $total_price, 'total_discount_price' => $total_discount_price, 'original_total' => $original_price]);
            } else {
