...
use App\Http\Controllers\API\SubmitAnswer\SentiTextController;
use App\Http\Controllers\API\SubmitAnswer\Config;
use App\Http\Controllers\API\SubmitAnswer\ConfigController;
...
class AnalyzerController extends Controller {
    ...
    */
    public function getSentiment($text)
    {
        ...
        $this->current_sentitext = new SentiTextController($text);
...
*/
     ...
     public function score_valence($sentiments, $text)
    {
        if ($sentiments) {
            ...
            $cn = New ConfigController;
            $compound = $cn->normalize($sum_s);
